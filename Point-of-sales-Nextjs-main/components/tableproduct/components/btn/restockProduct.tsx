...
function RestockButtonComponent({ product }: { product: { id: string; name: string; stock: number } }): React.ReactNode {
  ...
  return (
    <>
      ...
      <SheetRestock open={restockOpen} onClose={handleRestockClose} product={product} />
    </>
  );
}
