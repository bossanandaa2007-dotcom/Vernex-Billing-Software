...
import { MODULE_GROUPS, MODULE_KEYS, DEFAULT_MODULE_KEYS, type ModuleKey } from '@/lib/super-admin/modules';
...
export function CreateBusinessForm() {
  ...
  async function submit(event: FormEvent) {
    ...
    setLoading(true);
    setError('');
    const response = await fetch('/api/super-admin/admin/businesses', {
      method: 'POST',
