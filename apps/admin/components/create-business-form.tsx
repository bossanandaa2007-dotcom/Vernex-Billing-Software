...
const initial = { businessName: '', ownerName: '', email: '', phone: '', taxId: '', address: '', trialDays: '14', username: '', temporaryPassword: '' };
